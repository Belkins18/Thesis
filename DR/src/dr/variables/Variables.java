...
//==============================================================================
    ...
    public static String[] columnNames3 = {"X1", "X2", "X3", "X4", "X5", "X6",
        "X7", "X8", "X9", "X10", "X11", "X12"};
    public static String[] columnNames4 = {"F1", "F2", "F3", "F4", "F5", "F6",
        "F7", "F8", "F9", "F10", "F11", "F12", "F13", "F14", "F15", "F16"};
    public static String[] miner = {"er = min eij"};
    public static String[] summer = {"er = summ eij*qi"};
    public static String[] Xi = {"Xi"};
    public static String[] recomendate = {"В рамках даного рішення ЛПР орієнтується на передбачуване річне споживання D2, причому він припускає відмовитись від використання захисної упаковки і весь обсяг продукції реалізовувати тільки першому дистриб'ютору",
    "В рамках даного рішення ЛПР орієнтується на передбачуване річне споживання D2, "
            + "причому він припускає відмовитись від використання захисної упаковки "
            + "і весь обсяг продукції реалізовувати тільки другому дистриб'ютору",
    "В рамках даного рішення ЛПР орієнтується на передбачуване річне споживання D2, "
            + "причому він припускає відмовитись від використання захисної упаковки "
            + "і весь обсяг продукції реалізовувати рівними частками як першому , так і другому дистриб'ютору",
    "В рамках даного рішення ЛПР орієнтується на передбачуване річне споживання D2, "
            + "причому він припускає використовувати захисну упаковку і весь обсяг "
            + "продукції реалізовувати тільки першому дистриб'ютору",
    "В рамках даного рішення ЛПР орієнтується на передбачуване річне споживання D2, "
            + "причому він припускає використовувати захисну упаковку і весь обсяг "
            + "продукції реалізовувати тільки другому дистриб'ютору",
    "В рамках даного рішення ЛПР орієнтується на передбачуване річне споживання D2, "
            + "причому він припускає використовувати захисну упаковку і весь обсяг "
            + "продукції реалізовувати рівними частками як першому , так і другому дистриб'ютору",
    "В рамках даного рішення ЛПР орієнтується на передбачуване річне споживання D4, "
            + "причому він припускає відмовитись від використання захисної упаковки "
            + "і весь обсяг продукції реалізовувати тільки першому дистриб'ютору",
    "В рамках даного рішення ЛПР орієнтується на передбачуване річне споживання D4, "
            + "причому він припускає відмовитись від використання захисної упаковки "
            + "і весь обсяг продукції реалізовувати тільки другому дистриб'ютору",
    "В рамках даного рішення ЛПР орієнтується на передбачуване річне споживання D4, "
