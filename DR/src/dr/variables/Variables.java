...
//==============================================================================
    ...
    public static String[] maxer = {"er = max eij"};
    ...
    "\n   В рамках даного рішення ЛПР орієнтується на\n"
            + "передбачуване річне споживання D2,причому він\n"
            + "припускає відмовитись від використання захисної\n"
            + "упаковки і весь обсяг продукції реалізовувати\n "
            + "тільки другому дистриб'ютору",
    "\n   В рамках даного рішення ЛПР орієнтується на\n"
            + "передбачуване річне споживання D2, причому він\n"
            + "припускає відмовитись від використання захисної\n"
            + "упаковки і весь обсяг продукції реалізовувати \n"
            + "рівними частками як першому , так і другому \n"
            + "дистриб'ютору",
    "\n   В рамках даного рішення ЛПР орієнтується на\n "
            + "передбачуване річне споживання D2, причому він \n"
            + "припускає використовувати захисну упаковку і весь\n "
            + "обсяг продукції реалізовувати тільки першому \n"
            + "дистриб'ютору",
    "\n   В рамках даного рішення ЛПР орієнтується на \n"
            + "передбачуване річне споживання D2, причому він \n"
            + "припускає використовувати захисну упаковку і весь \n"
            + "обсяг продукції реалізовувати тільки другому \n"
            + "дистриб'ютору",
    "\n   В рамках даного рішення ЛПР орієнтується на \n"
            + "передбачуване річне споживання D2, причому він \n"
            + "припускає використовувати захисну упаковку і весь \n"
            + "обсяг продукції реалізовувати рівними частками як \n"
            + "першому , так і другому дистриб'ютору",
    "\n   В рамках даного рішення ЛПР орієнтується на \n"
            + "передбачуване річне споживання D4, причому він \n"
            + "припускає відмовитись від використання захисної \n"
            + "упаковки і весь обсяг продукції реалізовувати \n"
            + "тільки першому дистриб'ютору",
    "\n   В рамках даного рішення ЛПР орієнтується на \n"
            + "передбачуване річне споживання D4, причому він \n"
            + "припускає відмовитись від використання захисної \n"
            + "упаковки і весь обсяг продукції реалізовувати \n"
